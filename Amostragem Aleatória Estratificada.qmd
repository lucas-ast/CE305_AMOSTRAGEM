...
#### [Aula 01 - Amostragem Aleatória Estratificada Simples](https://youtu.be/9XBiTrfr1Xc?si=qv7kBLm70NalEdOJ)
...
n = 
\frac{
\left( \sum_{h=1}^{L} \frac{W_h S_h}{\sqrt{C_h}} \right)^2
}{
...
Suponha:
- $C = R\$ 10.000$ (orçamento total)
- $C_0 = R\$ 3.000$ (custo fixo/piloto)
